...
function selectTopik(element, topik) {
    ...
    document.getElementById('modalTitle').textContent = topik;
    document.getElementById('modalDesc').textContent = desc.description;
    document.getElementById('modalContent').innerHTML = desc.content;
...
// ===== FORM SUBMISSION =====
document.querySelector('.kontak-form').addEventListener('submit', function(event) {
